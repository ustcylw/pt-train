...
class DecodeBox():
    def __init__(self, anchors, num_classes, input_shape, anchors_mask = [[6,7,8], [3,4,5], [0,1,2]]):
        ...
        sllog << f'[DecodeBox]  {self.anchors=}  {self.bbox_attrs=}  {self.anchors_mask=}'
        
    def decode_box(self, inputs):
        outputs = []
        for i, input in enumerate(inputs):
            sllog << f'[decode_box]  {input.shape=}  {self.input_shape=}'
            #-----------------------------------------------#
            ...
            sllog << f'[decode_box]  {scaled_anchors=}'
            #-----------------------------------------------#
            #   输入的input一共有三个，他们的shape分别是
            ...
            sllog << f'[decode_box]  {input.shape=}  {prediction.shape=}'
            #-----------------------------------------------#
            #   先验框的中心位置的调整参数
            #-----------------------------------------------#
            ...
            # sllog << f'[decode_box]  {x.shape=}  {y.shape=}  {w.shape=}  {h.shape=}  {conf.shape=}'
            ...
            sllog << f'[decode_box]  {grid_x.shape=}  {grid_y.shape=}'
            ...
            sllog << f'[decode_box]  {anchor_w.shape=}  {anchor_h.shape=}'
            ...
            # sllog << f'[decode_box]  {pred_boxes.shape=}  {pred_boxes.min()=}  {pred_boxes.max()=}'
            ...
            # sllog << ''
        # sllog << f'[decode_box]  {outputs[0].shape=}  {outputs[0].min()=}  {outputs[0].max()=}'
        # sllog << f'[decode_box]  {outputs[1].shape=}  {outputs[1].min()=}  {outputs[1].max()=}'
        # sllog << f'[decode_box]  {outputs[2].shape=}  {outputs[2].min()=}  {outputs[2].max()=}'
        return outputs
    ...
    def non_max_suppression(self, prediction, num_classes, input_shape, image_shape, letterbox_image, conf_thres=0.5, nms_thres=0.4):
        ...
        prediction[:, :, :4] = box_corner[:, :, :4]  # <xyxy>
        ...
        for i, image_pred in enumerate(prediction):
            ...
            # sllog << f'[non_max_suppression]  {class_conf.max()=}  {image_pred[:, 4].max()=}  {prediction[:, 4].max()=}'
            ...
            # sllog << f'[non_max_suppression]  {image_pred[:, 4].max()=}  {class_conf[:, 0].max()=}  {tmp.max()=}'
            ...
            # sllog << f'[non_max_suppression]  {image_pred.shape=}  {conf_thres=}'
